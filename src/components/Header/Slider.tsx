...
// settings
import { slides, numberOfSlides } from '@/settings/slider';
      ...
      {slides.map((slide, i) => (
        <SwiperSlide key={i} id={`slide-${i}`}>
          <Image
            ...
            sizes="100vw"
            priority={i === 0}
            style={{ '--focus': slide.focus } as React.CSSProperties}
            className="slider-image object-cover will-change-transform"
